...
import { ARIA_LABEL as CATEGORY_LABEL_ARIA_LABEL } from '@/features/categories/CategoryLabel'
import {
...
describe('CategoryDetailHeader', () => {
  ...
  test('描画される', () => {
    const categoryDetailHeaderElement = screen.getByLabelText(ARIA_LABEL)
